...
TRADING_MODE = "SCALPING" # Режимы: "NORMAL" или "SCALPING"
RISK_MODE = "AGGRESSIVE" # Режим: "CONSERVATIVE", "BALANCED", "AGGRESSIVE"
AI_ENABLED = True
SYMBOLS = [
...
ML_PROBABILITY_THRESHOLD = 0.50  # Минимальная вероятность от ИИ для входа в сделку (от 0 до 1)
